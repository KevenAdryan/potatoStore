...
@Component({
  selector: 'app-detail-assada',
  templateUrl: './detail-assada.component.html',
  styleUrls: ['./detail-assada.component.scss'],
})
export class DetailAssadaComponent implements OnInit {
  constructor(
